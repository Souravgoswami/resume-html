...
def init
	...
	puts "#{COLOUR_PRIMARY}:: Watching for modified or new .erb files in #{__dir__}\e[0m"
	puts "#{COLOUR_SUCCESS}:: Found #{n_files} erb file#{n_files == 1 ? '' : 's' } so far...\e[0m\n\n"
end
